...
hi Folded     ctermbg=DarkMagenta  ctermfg=Black    guibg=LightGrey guifg=DarkBlue
...
hi Conditional  cterm=bold ctermfg=DarkYellow  gui=bold guifg=blue
hi Label  cterm=bold ctermfg=DarkYellow  gui=bold guifg=blue
hi Repeat  cterm=bold ctermfg=DarkYellow  gui=bold guifg=blue
